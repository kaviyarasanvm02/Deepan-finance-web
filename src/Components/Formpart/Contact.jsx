        ...
        <Container>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <Row>
                    ...
                    <CaptchaWrapper>
                            <CaptchaBox>
                                ...
                                <IconButton onClick={handleCaptchaRefresh} title="Refresh CAPTCHA">
                                <IoIosRefresh size={24} />
                                </IconButton>
                                <IconButton onClick={handleCaptchaSpeak} title="Speak CAPTCHA">
                                <GiSpeaker size={24} />
                                </IconButton>
                            </CaptchaBox>
                            <Input
                ...
                <Row>
                    ...
                    <FormGroup>
                        <FormControlLabel
                            control={<Checkbox checked={formData.agreeToPrivacy} className="p-2" onChange={handleFormChange} name="agreeToPrivacy" />}
                    ...
                    <FormGroup>
                    <FormControlLabel
                        control={<Checkbox checked={formData.agreeToCommunication} onChange={handleFormChange} name="agreeToCommunication" />}
